defmodule MpApiWeb.AuthCase do
  use Phoenix.ConnTest

  import Ecto.Changeset
  alias MpApi.{Accounts, Repo}
  ...
  def add_token_conn(conn, user) do
    user_token = Phauxth.Token.sign(MpApiWeb.Endpoint, user.id)
    conn
  ...
  def gen_key(email) do
    Phauxth.Token.sign(MpApiWeb.Endpoint, %{"email" => email})
  end
end
